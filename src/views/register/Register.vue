  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <button style="margin-left: 10px; width: 100px; height: 38px;" @click="getCode">发送验证码</button>
      </div>
      <div class="content">
        <label>登录密码:</label>
      ...
      <div class="controls">
        <input type="checkbox" name="agree" v-validate="{ required: true, tongyi: true }" :class="{ invalid: errors.has('agree') }">
