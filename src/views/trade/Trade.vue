<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="order in orderInfo.detailArrayList" :key="order.skuId">
          <li>
            <img :src="order.imgUrl" height="100px" width="100px">
          </li>
          <li>
            <p>
              {{ order.skuName }}</p>
          ...
          <li v-if="order.sourceType=='QUERY'">有货</li>
          <li v-else>无货</li>
        </ul>
      </div>
      <div class="bbs">
    ...
    <div class="sub clearFix">
      <a class="subBtn" @click="reqSubmitOrder">提交订单</a>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState({
      addressInfo: (state) => state.trade.orderInfo.userAddressList,
